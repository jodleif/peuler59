...
//	auto encrypted_file = xor_decrypt::fileio::strip_separator(constant::cipher);
	...
	auto t4 = t2 - t1;
	auto t5 = std::chrono::duration_cast<std::chrono::microseconds>(t4);
	std::cout << "Executed in: " << t4.count() << "ns, " << t5.count() << "microsec" << "\n";
	//std::cout << decrypted << "\n";
	return 0;
}